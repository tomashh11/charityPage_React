            ...
            <div className="mainStepsContainer">
                ...
                <div className="mainForm">
                    ...
                    <div className="yellowLabel">
                        ...
                        <p className="labelText">Wszystkie rzeczy do oddania zapakuj w 60l worki. Dokładną instrukcję
                ...
                <div className="stepTwoForm">
                    ...
                    <label className="stepTwoFormContainer">Liczba 60l worków:
                        ...
                        <select name="numberOfBags" className="stepTwoFormSelect"
                                onChange={(e) => handleOptionChange(e)}>
                            <option>--- wybierz ---</option>
                            {[...currentOptionsMap].map(([key, value]) => {
                                return <option value={key} selected={value.selected}
                                               key={key}>{value.numberOfBags}</option>
                            })}
                        </select>
                    </label>
