                ...
                <div className="mainStepsContainer">
                    ...
                    <div className="mainForm">
                        ...
                        <div className="yellowLabel">
                            ...
                            <p className="labelStepThreeText">Jeśli wiesz komu chcesz pomóc, możesz wpisać nazwę tej
                                organizacji w
                    ...
                    <div className="stepThreeForm">
                        ...
                        {[...currentGroups].map(([key, value]) => {
                            return <label key={key} className={"stepThreeContainer" + key}>
                                <input type="checkbox" className={"stepThree" + key} name={key} key={key}
                        ...
                        <label className="stepThreeOrganizationNameContainer">
                            <input type="text" name="organizationName" className="stepThreeOrganizationNameInput"
