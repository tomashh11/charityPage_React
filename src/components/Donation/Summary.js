        ...
        if (userState === null) {
            ...
            return <>
                ...
                <div className="summaryContainer">
                    ...
                    <div className="summaryStreetContainer">Ulica<span className="summaryStreet">{props.values.street}</span></div>
                    <div className="summaryCityContainer">Miasto <span className="summaryCity">{props.values.city}</span></div>
                    <div className="summaryPostCodeContainer"><div className="summaryPostCodeTitle">Kod pocztowy</div><span className="summaryPostCode">{props.values.postCode}</span></div>
                    <div className="summaryPhoneNumberContainer"><div className="summaryPhoneNumberTitle">Numer telefonu</div><span className="summaryPhoneNumber">{props.values.phoneNumber}</span></div>
                    <br/>
                    <h2 className="summaryDateOfReceiptTitle">Termin odbioru:</h2>
                    <div className="summaryDateOfReceiptContainer">Data <span className="summaryDateOfReceiptDate">{props.values.date}</span></div>
                    <div className="summaryTimeContainer">Godzina <span className="summaryTime">{props.values.time}</span></div>
                    <div className="summaryMessageToCourierContainer"><div className="summaryMessageToCourierTitle">Uwagi dla kuriera</div> <span className="summaryMessageToCourier">{props.values.messageToCourier}</span></div>
