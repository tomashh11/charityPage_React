                ...
                <div className="stepFourForm">
                    ...
                    <div>
                        <label className="addressContainer">
                            Ulica<input type="text" name="street" className="stepFourInputStreet" value={props.values.street}
                                        onChange={(e) => props.handleStreet(e.target.value)}/>
                        </label>
                    </div>
                    <div>
                    ...
                    <div>
                        <label className="addressContainerPostCode">
                            <div className="stepFourPostCode">Kod pocztowy</div><input type="text" name="postCode" className="stepFourInputPostCode" value={props.values.postCode}
                                               onChange={(e) => props.handlePostCode(e.target.value)}/>
                        </label>
                    </div>
                    <div>
                        <label className="addressContainerPhoneNumber">
                            <div className="stepFourPhoneNumber">Numer telefonu</div><input type="text" name="phoneNumber" className="stepFourInputPhoneNumber" value={props.values.phoneNumber}
                                                 onChange={(e) => props.handlePhoneNumber(e.target.value)}/>
                        </label>
                    </div>
                    <br/>
                    ...
                    <div>
                        <label className="stepFourDateOfReceiptDateContainer">
                            Data<input type="date" name="date" className="stepFourDateOfReceiptDateInput" value={props.values.date}
                                       onChange={(e) => props.handleDate(e.target.value)}/>
                        </label>
                    </div>
                    <div>
                        <label className="stepFourDateOfReceiptTimeContainer">
                            Godzina<input type="time" name="time" className="stepFourDateOfReceiptTimeInput" value={props.values.time}
                                          onChange={(e) => props.handleTime(e.target.value)}/>
                        </label>
                    </div>
                    <div>
                        <label className="stepFourDateOfReceiptMessageToCourierContainer">
                            <div className="stepFourMessageToCourierContainer">Uwagi dla kuriera</div><input type="textarea" name="messageToCourier" className="stepFourDateOfReceiptMessageToCourierInput"
                                                    value={props.values.messageToCourier}
                                                    onChange={(e) => props.handleMessage(e.target.value)}/>
                        </label>
                    </div>
